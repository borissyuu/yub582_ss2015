...
void main(){
    ...
    //translate(vec2(-.5)); // move space from the center to the vec2(0.0) and back to original place 
    //scale(vec2(sin(u_time))); //scale the space
    rotate(u_time); //rotate the space
